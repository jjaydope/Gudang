    ...
    <?php
       ...
       $tr_id = $_GET['id_transaksi'];
		...
		<header>
			...
			<address >
				<h7>Officer Name :<?php echo $data_transaksi['nama_kasir']; ?></h7
		...
		<article>
			...
			<table class="inventory">
				...
				<tbody>
                    ...
                    ?>
                    <!-- <?php echo $data_barang['id_barang']?> --></span></td>
			...
			<td><span ><h2>Penerima:</h2> <br/> <?php echo $data_transaksi['nama_member']; ?></span></td> </br></br><br/> <u>(...........)</u>
